    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <span className="text-2xl font-bold text-blue-400">HOOLI</span>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li><Link href="/solutions#connectivity" className="text-gray-400 hover:text-white text-sm">Global Connectivity</Link></li>
              <li><Link href="/solutions#analytics" className="text-gray-400 hover:text-white text-sm">Data Analytics</Link></li>
              <li><Link href="/solutions#security" className="text-gray-400 hover:text-white text-sm">Cybersecurity</Link></li>
              <li><Link href="/solutions#cloud" className="text-gray-400 hover:text-white text-sm">Cloud Services</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><Link href="/investors" className="text-gray-400 hover:text-white text-sm">Investor Relations</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">&copy; 2026 Hooli Corporation. All rights reserved.</p>
